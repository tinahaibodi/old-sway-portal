...
const CONTAINER_MAX_WIDTH = "78.325rem";
const LAYOUT_MAX_WIDTH = "87.5rem";
...
export const Section = styled.section<{
  ...
  grid-template-columns: ${({ layout }) =>
    !layout
      ? `minmax(4rem, auto) minmax(0, ${CONTAINER_MAX_WIDTH}) minmax(
      4rem,
      auto
    )`
      : `minmax(4rem, auto) minmax(0, ${LAYOUT_MAX_WIDTH}) minmax(4rem, auto)`};
  grid-gap: calc(12rem * 0.75) 0;
  gap: calc(12rem * 0.75) 0;
  padding: ${({ padding }) => padding || "3.71875rem 0"};
